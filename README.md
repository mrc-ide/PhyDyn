...
The latest version of the package (**v1.3.2**) has been compiled against BEAST v2.5.0. It will be available from the Beast repository soon.
...
```
> cp path-to-file/PhyDyn.v1.3.2.zip .
> unzip PhyDyn.v1.3.2.zip
```
